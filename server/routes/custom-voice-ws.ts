...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${STT_ARTIFACT_HARDENING}`;
            ...
            //
            // For NON-English sessions WITH continuity from prior sessions,
            // we route through Claude end-to-end so the topic names (which
            // are stored in English in session_summaries from pre-localize
            // history) get translated inline. Without this path, the
            // template produces mixed-language text like "L'ultima volta
            // abbiamo trattato Course deadlines and scheduling" — ElevenLabs
            // Turbo v2.5 auto-detects language per-phrase and switches its
            // voice from Italian to English mid-utterance. Bad UX. The
            // LLM path returns fully-Italian text so TTS stays Italian.
            //
            // English path is unchanged (template, fast, zero latency).
