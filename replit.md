...
-   **User-Controlled Speech Speed** (Oct 31, 2025): Dashboard Speech Speed slider (0.5-2.0 range) now directly controls voice pace in tutoring sessions. Previously saved but unused - now properly integrated with TTS service. Includes NaN validation and graceful fallback to default (0.95) for invalid values.
